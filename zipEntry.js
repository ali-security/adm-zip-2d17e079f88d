            ...
            case Utils.Constants.DEFLATED:
                ...
                if (!async) {
                    ...
                    inflater.inflateAsync(function (result, err) {
                        if (!callback) return;
                        if (err) {
                            // inflate failed (malformed stream, or the declared-size cap
                            // was exceeded) - surface the real reason instead of letting
                            // the empty result masquerade as a crc mismatch.
